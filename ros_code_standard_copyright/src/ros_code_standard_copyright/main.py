...
from ros_code_standard_copyright import CONTRIBUTING_FILETYPE
from ros_code_standard_copyright import get_copyright_names
from ros_code_standard_copyright import get_licenses
from ros_code_standard_copyright import LICENSE_FILETYPE
from ros_code_standard_copyright import SOURCE_FILETYPE
from ros_code_standard_copyright import UNKNOWN_IDENTIFIER
from ros_code_standard_copyright.crawler import get_files
from ros_code_standard_copyright.parser import get_comment_block
from ros_code_standard_copyright.parser import get_index_of_next_line
from ros_code_standard_copyright.parser import parse_file
from ros_code_standard_copyright.parser import scan_past_coding_and_shebang_lines
from ros_code_standard_copyright.parser import scan_past_empty_lines
from ros_code_standard_copyright.parser import search_copyright_information
...
def main(argv: list[str] | None = None) -> Literal[0, 1]:
    ...
    if not args.xunit_file and os.environ.get('MANYLINT_JUNIT_DIR'):
        args.xunit_file = os.path.join(os.environ['MANYLINT_JUNIT_DIR'], 'copyright.xunit.xml')
