...
from ros_code_standard_cpplint import cpplint
from ros_code_standard_cpplint.cpplint import _cpplint_state
from ros_code_standard_cpplint.cpplint import ParseArguments
from ros_code_standard_cpplint.cpplint import ProcessFile
...
def custom_get_header_guard_cpp_variable(filename):
    from ros_code_standard_cpplint.cpplint import _root
    from ros_code_standard_cpplint.cpplint import FileInfo
...
def main(argv: list[str] | None = None) -> Literal[0, 1]:
    ...
    if not args.xunit_file and os.environ.get('MANYLINT_JUNIT_DIR'):
        args.xunit_file = os.path.join(os.environ['MANYLINT_JUNIT_DIR'], 'cpplint.xunit.xml')
