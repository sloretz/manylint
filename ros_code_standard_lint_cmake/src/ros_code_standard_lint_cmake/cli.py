...
import ros_code_standard_lint_cmake.cmakelint as cmakelint
...
def main(argv=None):
    ...
    if not args.xunit_file and os.environ.get('MANYLINT_JUNIT_DIR'):
        args.xunit_file = os.path.join(
            os.environ['MANYLINT_JUNIT_DIR'], 'lint_cmake.xunit.xml')
    ...
    # invoke cmake lint
    cmakelint._lint_state = cmakelint._CMakeLintState()
    ...
    # Restore DefaultError
    cmakelint.Error = DefaultError
